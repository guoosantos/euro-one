...
import { Home, Cpu, HardDrive, Boxes, MapPinned, Car, Video, Camera, Cog } from 'lucide-react'
  ...
  return (
    <aside className="w-64 bg-[#0f141c] border-r border-[#1f2430] h-screen sticky top-0">
      <nav className="p-3 space-y-3">
        ...
        <NavLink to="/devices" className={linkClass}><Cpu size={18}/> Equipamentos</NavLink>
        <NavLink to="/devices/chips" className={linkClass}><HardDrive size={18}/> Chips</NavLink>
        <NavLink to="/devices/products" className={linkClass}><Boxes size={18}/> Produtos</NavLink>
