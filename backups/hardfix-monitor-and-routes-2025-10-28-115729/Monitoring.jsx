      <h1 className="text-2xl font-semibold mb-1">Monitoramento</h1>
<p className="text-sm text-[#9AA3B2] mt-1">Ordenado por última transmissão. Atualização a cada 30s.</p>
...
{<div className="flex items-center gap-2"><Select><option>A cada 30s</option></Select><Button>Atualizar</Button></div>}
