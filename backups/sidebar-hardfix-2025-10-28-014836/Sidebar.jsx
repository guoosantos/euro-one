  ...
  return (
    <aside className="hidden md:block w-64 shrink-0 border-r border-stroke bg-bg/60 backdrop-blur">
      ...
      <nav className="px-2 space-y-1">
        ...
        <MenuGroup icon={Cpu} label="Dispositivos" baseTo="/devices" baseLabel="Equipamentos" defaultOpen={true}><NavLink to="/devices" className={linkClass}>  <Cpu size={16}/> Equipamentos</NavLink>
        <MenuGroup icon={Cpu} label="Dispositivos" baseTo="/devices" baseLabel="Equipamentos" defaultOpen={true}><NavLink to="/devices/chips" className={linkClass}>  <Cpu size={16}/> Chips</NavLink>
