    ...
    <aside className="hidden md:block w-64 shrink-0 border-r border-stroke bg-bg/60 backdrop-blur">
      ...
      <nav className="px-2 space-y-1">
        ...
        <MenuGroup icon={Car} label="Veículos" baseTo="/vehicles" baseLabel="Vinculado" defaultOpen={true}>
          <NavLink to="/vehicles" className={linkClass}>  <Car size={16}/> Vinculado</NavLink>
          <NavLink to="/vehicles/available" className={linkClass}>  <Car size={16}/> Disponível</NavLink>
          <NavLink to="/vehicles/stock" className={linkClass}>  <Car size={16}/> Estoque</NavLink>
        </MenuGroup>
