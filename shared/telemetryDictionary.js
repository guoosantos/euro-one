...
const BASE_TELEMETRY_ATTRIBUTES = [
  ...
  { key: "vehicleVoltage", labelPt: "Tensão da Bateria do Veículo (V)", type: "number", unit: "V", priority: 30 },
  ...
  { key: "power", labelPt: "Tensão da Bateria do Veículo (V)", type: "number", unit: "V", priority: 50 },
  { key: "signalIn2", labelPt: "Entrada digital 2", type: "boolean", unit: null, priority: 60 },
  { key: "signalIn4", labelPt: "Entrada digital 4", type: "boolean", unit: null, priority: 61 },
  { key: "signalIn5", labelPt: "Entrada digital 5", type: "boolean", unit: null, priority: 62 },
  ...
  { key: "status", labelPt: "Status operacional do dispositivo", type: "string", unit: null, priority: 121 },
  ...
  { key: "fuelUsed", labelPt: "Combustível consumido", type: "number", unit: "L", priority: 160 },
  ...
  { key: "obdOdometer", labelPt: "Hodômetro via OBD", type: "number", unit: "km", priority: 180 },
  ...
  { key: "topSpeed", labelPt: "Velocidade máxima do veículo", type: "number", unit: "km/h", priority: 184 },
  ...
  { key: "geozoneInsidePrimary", labelPt: "Dentro de cerca eletrônica", type: "boolean", unit: null, priority: 195 },
  { key: "receivedCan", labelPt: "Quadros CAN Recebidos", type: "number", unit: null, priority: 196 },
  { key: "rssi", labelPt: "Intensidade do sinal celular (RSSI)", type: "number", unit: null, priority: 200 },
  { key: "sat", labelPt: "Número de satélites", type: "number", unit: null, priority: 210 },
  { key: "hdop", labelPt: "Precisão horizontal do GPS", type: "number", unit: null, priority: 220 },
...
const BASE_IO_FRIENDLY_NAMES = {
  ...
  io19: { key: "signalIn5", labelPt: "Entrada digital 5", type: "boolean" },
  io16: { key: "signalIn2", labelPt: "Entrada digital 2", type: "boolean" },
  io18: { key: "signalIn4", labelPt: "Entrada digital 4", type: "boolean" },
  io148: { key: "digitalOutput1", labelPt: "Saída digital 1", type: "boolean" },
