...
const BASE_TELEMETRY_ATTRIBUTES = [
  ...
  { key: "rssi", labelPt: "Intensidade do Sinal Celular", type: "number", unit: null, priority: 200 },
...
const SENSOR_LABEL_REPLACEMENTS = [
  ...
  [/driver seatbelt/gi, "cinto de segurança motorista"],
  [/passenger seatbelt/gi, "cinto de segurança passageiro"],
...
const DEFAULT_EVENT_CODE_MAP = new Map([
  ...
  ["98", { key: "doorFrontLeft", labelPt: "Porta Motorista" }],
  ["100", { key: "doorRearRight", labelPt: "Porta traseira direita" }],
  ["133", { key: "driverSeatbelt", labelPt: "Cinto de Segurança Motorista" }],
  ["134", { key: "passengerSeatbelt", labelPt: "Cinto de Segurança Passageiro" }],
  ["136", { key: "lowBeam", labelPt: "Farol" }],
  ["137", { key: "highBeam", labelPt: "Farol alto" }],
  ["139", { key: "handBrake", labelPt: "Freio de mão" }],
  ["141", { key: "engineWorking", labelPt: "Motor" }],
