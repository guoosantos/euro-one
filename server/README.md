...
- **Integração XDM (Embarque de Itinerário):**
  ...
  - Para múltiplos grupos (Itinerário/Alvos/Entrada), prefira overrides dedicados por role:
    ...
    - Alternativamente, use listas ordenadas por índice (ordem **obrigatória**: itinerary, targets, entry):
      - `XDM_GEOZONE_GROUP_OVERRIDE_IDS="123,456,789"`
      - `XDM_GEOZONE_GROUP_OVERRIDE_KEYS="geoGroup1,geoGroup2,geoGroup3"`
