...
export const routeConfig = [
  ...
  { path: "/commands/create", element: CreateCommands, title: "Criar Comandos", hideTitle: true, requireTenant: true, permission: { menuKey: "primary", pageKey: "commands", subKey: "create" } },
