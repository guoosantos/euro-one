...
export const routeConfig = [
  ...
  { path: "/services", element: Services, title: "Ordem de Serviço", requireTenant: true },
  { path: "/services/new", element: ServiceOrderNew, title: "Nova Ordem de Serviço", requireTenant: true },
