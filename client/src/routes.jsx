...
export const routeConfig = [
  ...
  { path: "/trips", element: Trips, title: "Trajetos", hideTitle: true, requireTenant: true },
  { path: "/routes", element: RoutesPage, title: "Rotas", requireTenant: true },
  { path: "/rotas", element: RoutesPage, title: "Rotas", requireTenant: true },
  { path: "/devices", element: Devices, title: "Equipamentos", hideTitle: true, requireTenant: true },
  { path: "/equipamentos", element: Devices, title: "Equipamentos", hideTitle: true, requireTenant: true },
  { path: "/devices/chips", element: Chips, title: "Chips", hideTitle: true, requireTenant: true },
  { path: "/chips", element: Chips, title: "Chips", hideTitle: true, requireTenant: true },
  { path: "/devices/products", element: Products, title: "Modelos & Portas", hideTitle: true, requireTenant: true },
  { path: "/devices/stock", element: Stock, title: "Estoque", hideTitle: true, requireTenant: true },
  ...
  { path: "/vehicles", element: Vehicles, title: "Veículos", hideTitle: true, requireTenant: true },
  { path: "/vehicles/:id", element: VehicleDetailsPage, title: "Veículo", requireTenant: true },
  { path: "/veiculos", element: Vehicles, title: "Veículos", hideTitle: true, requireTenant: true },
  ...
  { path: "/services", element: Services, title: "Ordem de Serviço", hideTitle: true, requireTenant: true },
  { path: "/services/new", element: ServiceOrderNew, title: "Nova Ordem de Serviço", hideTitle: true, requireTenant: true },
  { path: "/services/import", element: ServiceOrderImport, title: "Importar OS", requireTenant: true, roles: ["admin"] },
  { path: "/services/:id", element: ServiceOrderDetails, title: "Detalhes da OS", hideTitle: true, requireTenant: true },
  { path: "/services/:id/execute", element: ServiceOrderExecute, title: "Execução da OS", hideTitle: true, requireTenant: true },
  { path: "/appointments", element: Appointments, title: "Agendamentos", hideTitle: true, requireTenant: true },
  ...
  { path: "/itineraries", element: Itineraries, title: "Embarcar Itinerários", hideTitle: true, requireTenant: true },
  ...
  { path: "/reports/positions", element: ReportsPositions, title: "Relatório de posições", hideTitle: true, requireTenant: true },
  { path: "/reports/analytic", element: ReportsAnalytic, title: "Relatório Analítico", hideTitle: true, requireTenant: true },
