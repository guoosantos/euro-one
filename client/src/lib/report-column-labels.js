export const REPORT_COLUMN_LABELS = {
  ...
  deviceStatus: { label: "Status do dispositivo", tooltip: "Status do dispositivo" },
  deviceTemp: { label: "Temperatura do dispositivo", tooltip: "Temperatura do dispositivo" },
  rssi: { label: "Intensidade do sinal celular (RSSI)", tooltip: "Intensidade do sinal celular (dBm)" },
