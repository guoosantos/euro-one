...
export const REPORT_COLUMN_LABELS = {
  ...
  deviceTime: { label: "Data / Hora Envio", tooltip: "Data / Hora Envio" },
  serverTime: { label: "Data / Hora Recebido", tooltip: "Data / Hora Recebido" },
  ...
  eventType: { label: "Tipo", tooltip: "Tipo" },
  blocked: { label: "Bloqueado", tooltip: "Bloqueado" },
  whoSent: { label: "Quem enviou", tooltip: "Quem enviou" },
  eventActive: { label: "Evento Ativo", tooltip: "Evento Ativo" },
  eventSeverity: { label: "Severidade", tooltip: "Severidade" },
  criticality: { label: "Severidade", tooltip: "Severidade" },
