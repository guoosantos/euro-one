    ...
    pages: [
      ...
      },
      {
        ...
        subpages: [
          ...
          { subKey: "service-trainings", label: "Treinamentos" },
          { subKey: "service-sla", label: "SLA" },
    ...
    pages: [
      ...
      },
      {
        ...
        subpages: [
          ...
          { subKey: "users-create", label: "Criar usuários" },
          { subKey: "users-edit", label: "Editar usuários" },
          { subKey: "users-delete", label: "Excluir usuários" },
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { to: "/services/trainings", label: "Treinamentos", icon: GraduationCap, permission: { menuKey: "fleet", pageKey: "services", subKey: "service-trainings" } },
          { to: "/services/sla", label: "SLA", icon: Timer, permission: { menuKey: "fleet", pageKey: "services", subKey: "service-sla" } },
