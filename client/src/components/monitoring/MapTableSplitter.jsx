...
export default function MapTableSplitter({ onResize, currentPercent }) {
  ...
  return (
    <div
      ...
      className="map-splitter relative z-30 h-3 cursor-ns-resize select-none bg-gradient-to-b from-white/5 via-white/10 to-white/5"
    >
      <div className="map-splitter__handle absolute left-1/2 top-1/2 h-1.5 w-16 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/30" />
    </div>
  );
}
